...
const Navbar = () => {
    ...
    useEffect(() => {
        let QUEUE = songs.filter((x) => x.category == 'Motivational')
        setQueuesongs(QUEUE)
    }, [])

    return (
        <>
            <div className="bg-gray-100 invisible xl:visible lg:visible overflow-scroll fixed top-[14%] z-50 -right-[25%] hover:-right-0 transition-all duration-500  w-[30%] h-[60vh] max-h-[100vh] rounded-xl shadow-lg">
                ...
                <hr />
                <div className=''>
                    <div className='flex mx-5 mt-4 cursor-pointer'>
                        <img src={currentSong.audioImg} color={isPlaying ? 'teal' : ''} className='w-12 group' alt="" />
                        <div className='w-52 mx-2'>
                            <h3 className='truncate text-sm font-semibold text-teal-600'>{currentSong.name}</h3>
                            <div>
                                <h3 className='truncate text-sm text-teal-600'>{currentSong.singers}</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="sticky z-50 top-0 border-b-2 bg-gray-100 grid grid-cols-3 items-center justify-around py-2">
                <div className='relative xl:flex py-2 px-3 items-center'>
                    <NavLink to={'/'}>
                        <img src="./src/img/icons/jiosaavn-logo.png" className='w-28' alt="logo-button" />
                    </NavLink>
                    <div className='relative group md:flex flex-none list-none ml-5'>
                    ...
                    <ul className='xl:flex xl:w-fit lg:w-fit lg:flex md:w-20 sm:w-20 gap-5 mx-5 text-gray-800'>
                        <li className='cursor-pointer font-semibold'>Podcasts</li>
                        <li className='cursor-pointer font-semibold'>Go Pro</li>
                    </ul>
                </div>
                <div className='relative invisible xl:visible lg:visible'>
                    <input type="search" placeholder='Search' className='px-3 text-slate-800 outline-none rounded-full py-2 w-full text-center' name="" value={searchItem} onChange={handleSearch} />
                    <NavLink to={'searchsongs'}><CiSearch className='text-lg absolute top-[25%] right-[10%]' />
                    </NavLink>
                ...
                <div className='text-right mx-10'>
                    ...
                    <button className='mx-2 font-semibold text-slate-800 invisible xl:visible lg:visible'>Log In</button>
                    <button className='mx-2 font-semibold text-slate-800 invisible xl:visible lg:visible'>Sign Up</button>
                </div>
            </div>
        </>
    )
